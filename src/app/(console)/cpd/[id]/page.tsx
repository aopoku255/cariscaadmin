      ...
      <div className={styles.columns}>
        ...
        <aside className={styles.sideCol}>
          <Card>
            ...
            <LifecycleControls eventId={event.id} status={event.status} user={user} />
          </Card>
          ...
          <Card>
            ...
            <ul className={styles.checklist}>
              ...
              />
              <ChecklistItem
                done={!event.certificate?.issues || !!event.certificate.templateId}
                label="Certificate template"
                note={event.certificate?.issues && !event.certificate.templateId
                  ? 'Certificates are on but no template is chosen'
                  : undefined}
              />
            </ul>
          </Card>
